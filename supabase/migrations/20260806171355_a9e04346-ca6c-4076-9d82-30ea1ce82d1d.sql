...
BEGIN
  ...
  -- Unica fonte di verita' per 'admin': public.user_roles.
  ...
  -- Fallback limitato: primary_role puo' contenere anche ruoli-mansione
  -- ("Cameriere", ...) e non puo' mai conferire privilegi amministrativi.
