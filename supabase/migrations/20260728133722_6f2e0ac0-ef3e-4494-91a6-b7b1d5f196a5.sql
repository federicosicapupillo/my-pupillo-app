-- FASE 3 / migration 3: hardening bypass guard + grant vista
-- Rollback: ripristinare la versione precedente della funzione e i grant di default.
...
DECLARE
  ...
  blocked text[];
BEGIN
  -- Bypass: backend/service role (incl. funzioni SECURITY DEFINER, current_user = owner) e admin
