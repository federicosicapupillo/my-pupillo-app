...
BEGIN
  ...
  UPDATE public.applications SET status = 'accepted' WHERE id = v_runner_app;
  ...
  -- pulizia completa dei soli dati di prova creati qui
...
END;
$$;
REVOKE ALL ON FUNCTION public.tmp_test_overlap_notifications() FROM PUBLIC, anon, authenticated;