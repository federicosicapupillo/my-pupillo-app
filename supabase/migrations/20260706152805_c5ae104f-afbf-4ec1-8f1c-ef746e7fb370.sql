...
BEGIN
  ...
  -- Sanificazione numero documento: sempre attiva (uppercase + trim + regex se presente)
  ...
  -- Completezza campi ANAGRAFICI non-documento: sempre obbligatori
  ...
  -- Blocco DOCUMENTO: attivo solo se il flag require_id_document è ACCESO.
  IF require_doc THEN
    ...
    -- Gate SOLO del check "documento scaduto": attivo su INSERT, o su UPDATE
    -- se un campo documento è cambiato. Evita rollback su UPDATE di sistema
    -- (es. handle_new_review che aggiorna rating_avg/reviews_count).
  ...
  -- Validazioni codice fiscale / età / data nascita: sempre attive
