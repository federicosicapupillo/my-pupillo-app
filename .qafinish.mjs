...
const upd = { profile_completed: true, phone_verified: true, phone_verified_at: new Date().toISOString(),
  first_name:'QA', last_name:'Avail', full_name:'QA Avail', city:'Bologna', province:'BO', service_area_city:'Bologna', service_area_radius_m:15000, all_zones:true, spoken_languages:['Italiano'],
